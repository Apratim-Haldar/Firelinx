...
String stationID = "C/3"; // Default, will be loaded from EEPROM
...
User users[MAX_USERS] = {
  {{0x4A, 0x7A, 0x43, 0x2}, "Koyelisha", "C01", true},
  {{0x53, 0x40, 0xC9, 0x2C}, "Adrija", "C02", true}
};
...
typedef struct struct_message {
    ...
    char stnID[10];       // Station ID (e.g., "C/3") from EEPROM
...
void loadUsersFromEEPROM() {
    ...
    if (userCount < OG_USERS || userCount > MAX_USERS) {
        ...
        userCount = OG_USERS;
        users[0] = {{0x4A, 0x7A, 0x43, 0x2}, "Koyelisha", "C01", true};
        users[1] = {{0x53, 0x40, 0xC9, 0x2C}, "Adrija", "C02", true};
